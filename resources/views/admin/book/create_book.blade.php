                        ...
                        <form action="{{url('/admin/book')}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{$errors->has('price') ? 'has-error' : ''}}">
                                        ...
                                        <input type="number" min="0" step=".01" class="form-control" placeholder="Giá sách" name="price">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 {{$errors->has('inventory_num') ? 'has-error' : ''}}" >
                                    ...
                                    <input type="number" min="0" class="form-control" placeholder="Số lượng tồn" name="inventory_num" >
