            ...
            <div class="col-md-5">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h5>Thêm mới công ty phát hành</h5>
                    </div>
                    <div class="panel-body">
                        <form action="{{url('/admin/company/create')}}" method="post">
                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                            <div class="form-group {{$errors->has('name') ? 'has-error' : ''}}">
                                <label class="control-label">Tên công ty phát hành</label>
                                <input type="text" class="form-control" placeholder="Tên công ty phát hành" name="name">
